...
# Generated by Django 2.2.16 on 2022-06-21 04:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.SlugField(choices=[('user', 'юзер'), ('moderator', 'модератор'), ('admin', 'администратор'), ('superuser', 'суперюзер')], default='user', max_length=16, verbose_name='роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(null=True, verbose_name='Год публикации')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, 'Оценка должна быть не ниже 1'), django.core.validators.MaxValueValidator(10, 'Оценка должна быть не выше 10')], verbose_name='Оценка')),
